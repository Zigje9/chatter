...
export const privateChatLogOriginRequest = (payload) => {
  return {
    type: type.PRIVATE_CHAT_LOG_ORIGIN_REQUEST,
    payload,
  };
};

export const privateChatLogOrigin = (payload) => {
  return {
    type: type.PRIVATE_CHAT_LOG_ORIGIN,
    payload,
  };
};
